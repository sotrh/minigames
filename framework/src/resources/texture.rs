...
impl Texture {
    ...
    pub fn from_image(
        ...
        let texture = texture_from_rgba_img(device, queue, img, is_srgb);
...
pub fn texture_from_rgba_img(device: &wgpu::Device, queue: &wgpu::Queue, img: &image::DynamicImage, is_srgb: bool) -> wgpu::Texture {
